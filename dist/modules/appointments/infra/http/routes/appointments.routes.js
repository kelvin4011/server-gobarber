...
const providerAppointmentsController = new _ProviderAppointmentsController.default(); // Application the Middleware

appointmentsRouter.use(_ensureAuthenticated.default); // Create Appointments
...
}), appointmentsController.create); // List appointments of Providers
