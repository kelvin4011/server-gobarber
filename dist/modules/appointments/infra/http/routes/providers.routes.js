...
const providerDayAvailabilityController = new _ProviderDayAvailabilityController.default(); // Application the Middleware

providersRouter.use(_ensureAuthenticated.default); // List Providers

providersRouter.get('/', providersController.index); // Availability
